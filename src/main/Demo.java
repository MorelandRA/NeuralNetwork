...
import data.dataset.ANDDataSet;
import data.dataset.ConstantDataSet;
import data.dataset.DataSet;
import data.dataset.IrisDataSet;
import data.dataset.ORDataSet;
import data.dataset.SplitDataSet;
import data.dataset.XORDataSet;
import neuralnetwork.GraphNeuralNetwork;
import neuralnetwork.GraphNeuralNetworkAnalyzer;
...
public class Demo {
	...
	public static void main(String[] args) throws Exception {
		...
		constantDS.getMargins().set(0, 0.0001);
